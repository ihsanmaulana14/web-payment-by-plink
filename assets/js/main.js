! function (e) {
    ...
    var o = i(1),
        ...
        r = function e() {
            document.removeEventListener("DOMContentLoaded", e), window.main = new n.default,
                function e() {
    ...
    var r = function () {
        ...
        c = function () {
            function e() {
                n(this, e), window.main = this, TweenLite.defaultEase = Linear.easeNone, CSSPlugin.defaultForce3D = !0;
                var t = document.body.querySelector("#container");
                this.themePath = t.dataset.path, u.default.resize(), this._init(), u.default.isTouch && (window.addEventListener("touchstart", u.default.onTouchStart), window.addEventListener("touchmove", u.default.onMouseMove)), window.addEventListener("mousemove", u.default.onMouseMove), window.addEventListener("resize", this._onResize.bind(this)), "plink.local.com" === location.hostname && document.body.classList.add("show-grid"), window.addEventListener("keydown", function (e) {
    ...
    var s, a = function () {
        ...
        }(), r(s.prototype, "_onPageHidden", [p.default], Object.getOwnPropertyDescriptor(s.prototype, "_onPageHidden"), s.prototype), r(s.prototype, "_onPopinHidden", [p.default], Object.getOwnPropertyDescriptor(s.prototype, "_onPopinHidden"), s.prototype), r(s.prototype, "_onPageShown", [p.default], Object.getOwnPropertyDescriptor(s.prototype, "_onPageShown"), s.prototype), s);
    t.default = m
}, function (e, t, i) {
    "use strict";
    ...
    var r, s = function () {
        ...
        g = (o(m), r = function () {
            function e() {
                n(this, e), this.changed = new c.default,
                    function (e) {
                        var t = e.pushState;
                    ...
                    }(window.history), (0, d.default)(document.body, "a:not([target])", "click", this._onClickLink.bind(this)), window.addEventListener("popstate", this._onPopState), window.addEventListener("pushstate", this._onPopState), this.parser = document.createElement("a"), this.url = this._sanitizeUrl(window.location.href), this.origin = window.location.origin, history.replaceState(null, document.title, this.url)
            }
            return s(e, [{
                key: "_sanitizeUrl",
                value: function (e) {
        ...
        }(r.prototype, "_onPopState", [p.default], Object.getOwnPropertyDescriptor(r.prototype, "_onPopState"), r.prototype), r);
    t.default = g
}, function (e, t) {
    "use strict";
    ...
    ! function (n) {
        ...
        r.prototype = {
            ...
            _registerListener: function (e, t, i, o) {
                ...
                if (-1 !== s) {
                    if (n = this._bindings[s], n.isOnce() !== t) throw new Error("You cannot add" + (t ? "" : "Once") + "() then add" + (t ? "Once" : "") + "() the same listener without removing the relationship first.")
            ...
            _indexOfListener: function (e, t) {
                for (var i, o = this._bindings.length; o--;)
                    if (i = this._bindings[o], i._listener === e && i.context === t) return o;
                return -1
            },
            has: function (e, t) {
    ...
    Object.defineProperty(t, "__esModule", {
        value: !0
    }), t.boundMethod = o, t.boundClass = n, t.default = r
}, function (e, t) {
    "use strict";
    ...
    }, o.dpr = void 0 !== window.devicePixelRatio ? window.devicePixelRatio : 1, o.isTouch = "ontouchstart" in window || navigator.maxTouchPoints, o.isMobile = window.mobileAndTabletcheck(), o.isIOS = /iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream;
    var n = navigator.userAgent.toLowerCase();
    o.isTablet = /(ipad|tablet|(android(?!.*mobile))|(windows(?!.*phone)(.*touch))|kindle|playbook|silk|(puffin(?!.*(IP|AP|WP))))/.test(n), o.isFirefox = "undefined" != typeof InstallTrigger, o.isSafari = /constructor/i.test(window.HTMLElement) || function (e) {
        return "[object SafariRemoteNotification]" === e.toString()
    }(!window.safari || "undefined" != typeof safari && safari.pushNotification), o.isIE = !!document.documentMode, o.isEdge = !o.isIE && !!window.StyleMedia, o.isMobile && !o.isTablet && document.body.classList.add("is-mobile"), o.isTablet && document.body.classList.add("is-tablet"), o.isTouch && document.body.classList.add("is-touch"), o.isFirefox && document.body.classList.add("is-firefox"), o.isSafari && document.body.classList.add("is-safari"), o.isEdge && document.body.classList.add("is-edge"), o.isIE && document.body.classList.add("is-ie"), o.isIOS && document.body.classList.add("is-ios"), "IntersectionObserver" in window ? o.hasIO = !0 : document.body.classList.add("no-io"), o.resize = function () {
        o.lockResize || (o.width = document.body.offsetWidth, o.height = window.innerHeight, o.diagonal = Math.sqrt(o.width * o.width + o.height * o.height), o.centerX = .5 * o.width, o.centerY = .5 * o.height, o.mobile = o.width < 740)
    ...
    }, o.scrollY = 0, o.scrollSpeed = 0, o.easedScrollSpeed = 0, o.absEasedScrollSpeed = 0, o.lastMouseX = 0, o.lastMouseY = 0, o.easedMouseX = 0, o.easedMouseY = 0, o.mouseSpeedX = 0, o.mouseSpeedY = 0, o.easedMouseSpeedX = 0, o.easedMouseSpeedY = 0, o.updatePhysics = function () {
        this.easedScrollSpeed += .1 * (o.scrollSpeed - o.easedScrollSpeed), this.absEasedScrollSpeed += .1 * (Math.abs(o.scrollSpeed) - o.absEasedScrollSpeed), this.easedMouseX += .09 * (this.mouseX - this.easedMouseX), this.easedMouseY += .09 * (this.mouseY - this.easedMouseY), this.mouseSpeedX = this.mouseX - this.lastMouseX, this.mouseSpeedY = this.mouseY - this.lastMouseY, this.easedMouseSpeedX += .03 * (Math.abs(this.mouseSpeedX) - this.easedMouseSpeedX), this.easedMouseSpeedY += .03 * (Math.abs(this.mouseSpeedY) - this.easedMouseSpeedY), this.lastMouseX = this.mouseX, this.lastMouseY = this.mouseY
    }, o.isRetina = function () {
    ...
    var l, u = function () {
        ...
        j = (l = function (e) {
            function t(e, i) {
                ...
                return t.header || (t.header = new v.default), t.footer || (t.footer = new g.default), o
            }
            return s(t, e), u(t, [{
                key: "init",
                value: function () {
                    if (c(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), "init", this).call(this), p.default.isSafari && this.previousPage || p.default.isIOS && this.previousPage) {
                    ...
                    if (p.default.currentPage = this, p.default.scrollable = this.scrollable, this.initLangBtn(), this.initLazyLoading(), this.initNavColorSwitch(), this.initBlocAnimations(), this.initScrollLoops(), this.initPrllx(), "getpaidfast" == this.id) return t.header.dom.style.display = "none", document.body.style.background = "#151515", document.documentElement.style.position = "relative", void(document.documentElement.style.overflow = "hidden");
                    if ("home" != this.id && (t.header.show(), document.body.style.background = "#151515", document.documentElement.style.position = "relative"), p.default.isMobile) {
                ...
                key: "resize",
                value: function () {
                    c(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), "resize", this).call(this), this.navColorSwitch && this.navColorSwitch.resize(), this.scrollLoops.forEach(function (e) {
                        e.resize()
                ...
                key: "update",
                value: function () {
                    c(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), "update", this).call(this), this.scrollLoops.forEach(function (e) {
                        e.update()
                    }), this.blockAnimations && this.blockAnimations.forEach(function (e) {
                        e.update()
                    })
                ...
                key: "destroy",
                value: function () {
                    c(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), "destroy", this).call(this), this.navColorSwitch && this.navColorSwitch.destroy()
                }
            }, {
                key: "_show",
                value: function () {
                ...
                value: function () {
                    this.langList._isVisible = !0, TweenLite.to(this.langList, .05, {
                        ...
                        x: 0,
                        y: 0
                    }), document.addEventListener(p.default.isTouch ? "touchstart" : "click", this.onClickOutsideLangBtn), document.addEventListener("wheel", this.onWheel)
                }
            }, {
                key: "onWheel",
                value: function (e) {
                ...
                value: function () {
                    this.langList._isVisible = !1, TweenLite.to(this.langList, .05, {
                        ...
                        x: 5,
                        y: 5
                    }), document.removeEventListener(p.default.isTouch ? "touchstart" : "click", this.onClickOutsideLangBtn), document.removeEventListener("wheel", this.onWheel)
                }
            }, {
                key: "initBlocAnimations",
                value: function () {
                    var e = this;
                    p.default.isMobile || (this.blockAnimations = [], p.default.isMobile || (this.blockAnimationsDom = Array.from(this.dom.querySelectorAll(".block-anim")), this.blockAnimationsDom.forEach(function (t) {
                        var i = new P.default({
                            wrapper: t
                        });
                ...
                value: function () {
                    p.default.isMobile && !p.default.isTablet || (t.header.onColorSwitch("#FFFFFF"), this.navColorSwitch = new w.default({
                        defaultColor: "#FFFFFF",
                        ...
                        t = new IntersectionObserver(function (e) {
                            e.forEach(function (e) {
                                if (e.isIntersecting) {
                                    ...
                                    } else i.dataset.src && (i.src = i.dataset.src), i.dataset.srcset && (i.srcset = i.dataset.srcset);
                                    i.classList.remove("lazy"), t.unobserve(i), TweenLite.to(i, .5, {
                                        autoAlpha: 1,
                                        ease: Power2.easeOut
                                    })
                                }
        ...
        }(d.default), a(l.prototype, "onClickLangBtn", [T.default], Object.getOwnPropertyDescriptor(l.prototype, "onClickLangBtn"), l.prototype), a(l.prototype, "onClickOutsideLangBtn", [T.default], Object.getOwnPropertyDescriptor(l.prototype, "onClickOutsideLangBtn"), l.prototype), a(l.prototype, "onWheel", [T.default], Object.getOwnPropertyDescriptor(l.prototype, "onWheel"), l.prototype), a(l.prototype, "hideLangList", [T.default], Object.getOwnPropertyDescriptor(l.prototype, "hideLangList"), l.prototype), l);
    t.default = j
}, function (e, t, i) {
    "use strict";
        ...
        m = function (e) {
            ...
            return s(t, e), a(t, [{
                ...
                value: function () {
                    ...
                    e && v.default.deviceType, this.scrollable = new p.default(e, this)
                }
            }, {
                key: "resize",
                value: function () {
    ...
    var r, s = function () {
        ...
        d = (r = function () {
            function e(t, i) {
                n(this, e), this.dom = t, this.id = t.getAttribute("id"), this.uid = this.id + "-" + (1e5 * Math.random() | 0), this.pageId = this.id, this.startHide = new u.default, this.hidden = new u.default, this.startShow = new u.default, this.shown = new u.default, this.previousPage = i, i && !i.isHidden && (this._previousPage = i, this._previousPage.hidden.add(this._onPreviousPageHidden.bind(this)))
            }
            return s(e, [{
                key: "init",
                value: function () {}
        ...
        }(r.prototype, "_hidden", [h.default], Object.getOwnPropertyDescriptor(r.prototype, "_hidden"), r.prototype), r);
    t.default = d
}, function (e, t, i) {
    "use strict";
    ...
    var l, u = function () {
        ...
        w = (l = function (e) {
            ...
            return s(t, e), u(t, [{
                ...
                value: function () {
                    ...
                    if (!this.isLocked)
                        if (void 0 !== this._y) {
                            if (this.deltaY = this._y - this.y, e) this.vy = 0, this.y = this._y;
        ...
        }(m.default), a(l.prototype, "_onMouseDown", [b.default], Object.getOwnPropertyDescriptor(l.prototype, "_onMouseDown"), l.prototype), a(l.prototype, "_onMouseScroll", [b.default], Object.getOwnPropertyDescriptor(l.prototype, "_onMouseScroll"), l.prototype), a(l.prototype, "_onTouchStart", [b.default], Object.getOwnPropertyDescriptor(l.prototype, "_onTouchStart"), l.prototype), a(l.prototype, "_onTouchMove", [b.default], Object.getOwnPropertyDescriptor(l.prototype, "_onTouchMove"), l.prototype), a(l.prototype, "_onTouchEnd", [b.default], Object.getOwnPropertyDescriptor(l.prototype, "_onTouchEnd"), l.prototype), a(l.prototype, "_onScroll", [b.default], Object.getOwnPropertyDescriptor(l.prototype, "_onScroll"), l.prototype), l);
    t.default = w
}, function (e, t) {
    "use strict";
    var i = e.exports = function () {};
    ...
    var a, l = function () {
        ...
        g = (a = function (e) {
            function t(e, i) {
                n(this, t);
                var o = r(this, (t.__proto__ || Object.getPrototypeOf(t)).apply(this, arguments));
                return o.page = i, o.height = void 0, o.eased = !y.default.isMobile, o.isNative = y.default.isMobile, o.html = document.documentElement, o.body = document.body, o.y = window.pageYOffset || document.documentElement.scrollTop, o.vy = 0, o.lastHeight = 0, o.lastScrollPos = o.y, o._tlElts = [], y.default.isMobile || (o.dom.style.position = "fixed", o.bindImagesLoad(), setTimeout(o.checkPageHeight, 60)), o
            }
            return s(t, e), l(t, [{
                key: "destroy",
                value: function () {
                    u(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), "destroy", this).call(this), this._tl && this.clearTimeline(this._tl)
                }
            }, {
                key: "bindImagesLoad",
                value: function () {
                ...
                value: function () {
                    if (!this.fixedScroll) {
                        ...
                        this.height = t < y.default.height ? y.default.height : t, this.resetTimeline(), this.isNative || (document.body.style.height = this.height + "px", t <= y.default.height || (e.style.overflowY = "scroll", this.updateDom()))
                    }
                }
            }, {
                key: "lock",
                value: function () {
                    y.default.isMobile || (this.lastScrollPos = window.pageYOffset || document.documentElement.scrollTop, document.body.style.height = y.default.height + "px", this.isLocked = !0)
                }
            }, {
                key: "unlock",
                value: function () {
                    y.default.isMobile || (this.height < y.default.height ? document.body.style.height = y.default.height + "px" : (document.body.style.height = this.height + "px", document.documentElement.style.overflowY = "scroll", document.documentElement.scrollTop = document.body.scrollTop = this.lastScrollPos), this.isLocked = !1)
                }
            }, {
                key: "update",
                value: function () {
                    if (!this.isLocked) {
                        ...
                        this.vy = e - this.y, this.eased ? this.y += .12 * this.vy : this.y = e, y.default.scrollSpeed = this.vy, y.default.scrollY = this.y
                    }
                }
            }, {
                key: "updateDom",
                value: function () {
                    this.isNative || (this.scrollRatio = this.y / (this.height - y.default.height), this.scrollRatio < 0 ? this.scrollRatio = 0 : this.scrollRatio > 1 && (this.scrollRatio = 1), this._tl && this._tl.progress(this.scrollRatio), this.fixedScroll || TweenLite.set(this.dom, {
                        y: -this._y
                    }))
                }
            }, {
                ...
                value: function (e) {
                    ...
                    var o = y.default.isSafari ? document.body : document.documentElement;
                    TweenLite.to(o, t, {
                        scrollTo: e,
                        ease: i,
                        overwrite: "all",
                ...
                key: "setHeight",
                value: function (e) {
                    e = Math.round(e), this.fixedScroll = !0, this.height = e, this.isLocked || (this.height < y.default.height ? this.body.style.height = y.default.height + "px" : (this.body.style.height = this.height + "px", this.html.style.overflowY = "scroll"), this.updateDom())
                }
            }, {
                key: "resetTimeline",
                value: function () {
                ...
                key: "y",
                get: function () {
                    return y.default.isMobile ? document.documentElement.scrollTop || document.body.scrollTop : this._y
                },
                set: function (e) {
                    this._y = e, Math.abs(this.vy) > .09 && this.updateDom()
                }
            }]), t
        }(f.default), function (e, t, i, o, n) {
            var r = {};
            return Object.keys(o).forEach(function (e) {
                r[e] = o[e]
            }), r.enumerable = !!r.enumerable, r.configurable = !!r.configurable, ("value" in r || r.initializer) && (r.writable = !0), r = i.slice().reverse().reduce(function (i, o) {
        ...
        }(a.prototype, "checkPageHeight", [m.default], Object.getOwnPropertyDescriptor(a.prototype, "checkPageHeight"), a.prototype), a);
    t.default = g
}, function (e, t, i) {
    "use strict";
    ...
    var r, s = function () {
        ...
        h = (r = function () {
            function e() {
                if (n(this, e), this.dom = document.body.querySelector(".header"), this.navDom = this.dom.querySelector("nav"), this.logoSvg = this.dom.querySelector(".logo svg"), this._navColor = "#FFFFFF", l.default.isMobile & !l.default.isTablet) {
        ...
        }(r.prototype, "onColorSwitch", [c.default], Object.getOwnPropertyDescriptor(r.prototype, "onColorSwitch"), r.prototype), r);
    t.default = h
}, function (e, t, i) {
    "use strict";
    ...
    var n = function () {
        ...
        a = function () {
            function e(t) {
                o(this, e), this.defaultColor = t.defaultColor, this.element = t.element, this.selector = t.selector, this.callback = t.callback, this.switches = Array.from(s.default.currentPage.dom.querySelectorAll(this.selector)), this.switches.forEach(function (e, t) {
            ...
            return n(e, [{
                ...
                value: function () {
                    ...
                    var t = this.element.offsetTop + .5 * this.element.offsetHeight,
    ...
    var r, s = function () {
        ...
        h = (r = function () {
            function e(t) {
                n(this, e), this.wrapper = t.wrapper, this.loop = this.wrapper.querySelector("div"), this.span = this.wrapper.querySelector("div span"), this.debug = !!this.wrapper.classList.contains("debug"), this.x = 0, this.speed = .61, setTimeout(this.init, 60)
            }
            return s(e, [{
                key: "init",
                value: function () {
                ...
                value: function (e) {
                    var t = e.offsetTop;
                    return e.parentElement != l.default.scrollable.dom && (e.parentElement._gsTransform && (t += e.parentElement._gsTransform.y), t += this.getPageY(e.parentElement)), t
                }
            }, {
                key: "resize",
                value: function () {
                ...
                set: function (e) {
                    ...
                    this.debug && console.log(t, l.default.height + this.wrapper.offsetHeight), TweenLite.set(this.loop, {
                        x: this.x
                    })
                }
            }]), e
        ...
        }(r.prototype, "init", [c.default], Object.getOwnPropertyDescriptor(r.prototype, "init"), r.prototype), r);
    t.default = h
}, function (e, t, i) {
    "use strict";
    ...
    var n = function () {
        ...
        a = function () {
            function e(t) {
                o(this, e), this.wrapper = t.wrapper, this.slide = !this.wrapper.classList.contains("no-slide"), this.justBellow = this.wrapper.classList.contains("just-below"), this.isShown = !0, this.debug = this.wrapper.classList.contains("debug"), this.oneTime = this.wrapper.classList.contains("one-time"), this.margin = this.justBellow ? -1 : .12 * s.default.width, this.wrapper._tl && this.wrapper._tl.progress(1)
            }
            return n(e, [{
                key: "resize",
                value: function () {
                    this.margin = this.justBellow ? -1 : .12 * s.default.width, this.pageY = this.getPageY(this.wrapper)
                }
            }, {
                key: "update",
                value: function () {
                    if (!this.disabled) {
                        ...
                        e < s.default.height - .7 * this.wrapper.offsetHeight ? this.isShown || this.show() : e > s.default.height + this.margin && this.isShown && this.hide(), this.debug && console.log(e, s.default.height)
                    }
                }
            }, {
                key: "show",
                ...
                value: function (e) {
                    var t = e.offsetTop;
                    return e.parentElement != s.default.scrollable.dom && (this.debug && console.log(e, e.offsetTop, e.offsetHeight), t += this.getPageY(e.parentElement)), t
                }
            }, {
                key: "getScreenY",
                value: function () {
                    var e = 0;
                    return this.wrapper.parentElement._gsTransform && (e += this.wrapper.parentElement._gsTransform.y), this.wrapper._gsTransform && (e += this.wrapper._gsTransform.y), this.pageY - s.default.scrollY + e
                }
            }]), e
        }();
    t.default = a
            ...
            return n(e, [{
                ...
                value: function () {
                    var e = this.delta * s.default.height / 700,
                        ...
                        i = this.scrollable.height / (this.scrollable.height - s.default.height),
                        o = this.getPageY(this.wrapper),
                        n = this.wrapper.offsetHeight * i;
                    if (0 == o) this.scrollable._tl.fromTo(this.elt, n, {
                        y: 0
                    }, {
                        y: 2 * e,
                        ...
                        if (n = (s.default.height + this.wrapper.offsetHeight) * i, o < s.default.height) r.fromTo(this.elt, n, {
                            y: -e + t
                        }, {
                            y: e + t,
                            ease: Power0.easeInOut
                        }, 0), this.scrollable._tl.add(r, 0);
                        else {
                            var a = (o - s.default.height) * i;
                            this.forceEnd ? (r.fromTo(this.elt, n, {
                                y: 2 * -e
                            }, {
                                y: 0,
                                ease: Power0.easeInOut
                            }, 0), this.scrollable._tl.add(r, this.scrollable._tl.duration() - n)) : (r.fromTo(this.elt, n, {
                                y: -e + t
                            }, {
                                y: e + t,
                                ease: Power0.easeInOut
                            }, 0), this.scrollable._tl.add(r, a))
                        }
                    }
                }
            }, {
    ...
    var l, u = function () {
        ...
        b = (l = function (e) {
            ...
            return s(t, e), u(t, [{
                ...
                value: function () {
                    ...
                    this.initAnimations(), c(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), "init", this).call(this);
                    ...
                    }), this._introEnded = !1, this.initIntroReplay(), this.previousPage ? (this.introVideo.load(), this.replayIntro()) : this.skipIntro ? (document.body.style.background = "#151515", p.default.header.show(), this.replayIntro()) : this.playIntro()
                }
            }, {
                key: "playIntro",
                value: function () {
                ...
                key: "resize",
                value: function () {
                    c(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), "resize", this).call(this), this.qrBall && this.qrBall.resize()
                }
            }, {
                key: "update",
                value: function () {
                    c(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), "update", this).call(this), this.qrBall && this.qrBall.update(), !this.haveScrolled && this.scrollable.y > 0 && (this.haveScrolled = !0, TweenLite.to(this._arrow, .5, {
                        autoAlpha: 0,
                        y: 30,
                        ease: Power2.easeIn
                    }))
                ...
                value: function () {
                    ...
                    if (n.words.forEach(function (t, i) {
                            TweenLite.set(t, {
                                scale: .7,
        ...
        }(p.default), a(l.prototype, "startDomAnim", [v.default], Object.getOwnPropertyDescriptor(l.prototype, "startDomAnim"), l.prototype), a(l.prototype, "onLoopStarted", [v.default], Object.getOwnPropertyDescriptor(l.prototype, "onLoopStarted"), l.prototype), l);
    t.default = b
}, function (e, t, i) {
    "use strict";
    ...
    var r = function () {
        ...
        c = function () {
            function e(t) {
                var i = this;
                n(this, e), this.wrapper = t.wrapper, this.dom = t.dom, this.qrCode = this.dom.querySelector(".home_scan_qr-code-image"), this.focus = this.qrCode.querySelector("svg"), this.logoBall = document.createElement("div"), this.logoBall.classList.add("qr-ball"), this.logo = u.default.header.dom.querySelector(".logo"), this.logo.appendChild(this.logoBall), this.menuBall = document.createElement("div"), this.menuBall.classList.add("qr-ball"), this.menu = u.default.header.dom.querySelector(".header_menu"), this.menu.appendChild(this.menuBall), this.x = 0, this.y = 0, this._speedX = 0, this._speedY = 0, this.scaleQr = 1, this.scale = 0, this.aScale = 0, this.sinScale = 0, this.sinScaleAmp = 1, this.t = 0, this.b = .7, this.k = .09, new IntersectionObserver(function (e) {
                    e.forEach(function (e) {
                        e.isIntersecting && a.default.scrollable.y > 0 ? (TweenLite.to(i, 1.2, {
                            aScale: 1,
            ...
            return r(e, [{
                ...
                value: function () {
                    ...
                    this.dom.parentElement._gsTransform && (t += -this.dom.parentElement._gsTransform.y), t += a.default.mouseY - .5 * this.dom.offsetHeight;
                    var i = e - this.x,
                        o = t - this.y;
                ...
                value: function (e) {
                    var t = e.offsetTop;
                    return e.parentElement != a.default.scrollable.dom && (t += this.getPageY(e.parentElement)), t
                }
            }, {
                key: "x",
                get: function () {
                ...
                set: function (e) {
                    if (this._x = e, this.isVisible) {
                        ...
                        var t = e - this.logo.offsetLeft + a.default.centerX - .5 * this.dom.offsetWidth;
                        TweenLite.set(this.logoBall, {
                            x: t
                        }), t = e - this.menu.parentElement.offsetLeft + a.default.centerX - .5 * this.dom.offsetWidth, TweenLite.set(this.menuBall, {
                            x: t
                        })
                    }
                }
                ...
                set: function (e) {
                    if (this._y = e, this.isVisible) {
                        ...
                        var t = e - (a.default.scrollable.y - this.pageY + this.logo.offsetTop);
                        this.dom.parentElement._gsTransform && (t += this.dom.parentElement._gsTransform.y), TweenLite.set(this.logoBall, {
                            y: t
                        }), t = e - (a.default.scrollable.y - this.pageY + this.menu.offsetTop + this.menu.parentElement.offsetTop), this.dom.parentElement._gsTransform && (t += this.dom.parentElement._gsTransform.y), TweenLite.set(this.menuBall, {
                            y: t
                        })
                    }
                }
    ...
    var a = function () {
        ...
        p = (o(f), function (e) {
            ...
            return s(t, e), a(t, [{
                ...
                key: "_show",
                value: function () {
                    l(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), "_show", this).call(this)
                }
            }, {
                key: "_hide",
                value: function () {
                    l(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), "_hide", this).call(this)
                }
            }]), t
        }(d.default));
    t.default = p
    ...
    var o = function () {
        ...
        n = function () {
            ...
            return o(e, null, [{
                key: "rgb2hex",
                value: function (e) {
                    return e = e.match(/^rgba?[\s+]?\([\s+]?(\d+)[\s+]?,[\s+]?(\d+)[\s+]?,[\s+]?(\d+)[\s+]?/i), e && 4 === e.length ? "0x" + ("0" + parseInt(e[1], 10).toString(16)).slice(-2) + ("0" + parseInt(e[2], 10).toString(16)).slice(-2) + ("0" + parseInt(e[3], 10).toString(16)).slice(-2) : ""
                }
            }, {
                key: "shuffle",
                value: function (e) {
                ...
                key: "getCookie",
                value: function (e) {
                    for (var t = e + "=", i = decodeURIComponent(document.cookie), o = i.split(";"), n = 0; n < o.length; n++) {
                        for (var r = o[n];
    ...
    t.default = n, Array.from || (Array.from = function () {
        ...
        return function (e) {
            ...
            for (var a, l = n(o.length), u = t(i) ? Object(new i(l)) : new Array(l), c = 0; c < l;) a = o[c], u[c] = s ? void 0 === r ? s(a, c) : s.call(r, a, c) : a, c += 1;
            return u.length = l, u
        }
    }())
}, function (e, t, i) {
    ...
    ! function (r, s) {
        ...
        function i(e, t, i, r) {
            var a = ["then", "catch", "always"],
                ...
                h = o(t, i, e);
            return c.open(e, h, !0), c.withCredentials = r.hasOwnProperty("withCredentials"), n(c, r.headers, i), c.addEventListener("readystatechange", s(l, c), !1), c.send(u(i) ? JSON.stringify(i) : i), l.abort = function () {
                return c.abort()
            }, l
        }
        ...
        function n(e, t, i) {
            t = t || {}, r(t) || (t["Content-Type"] = u(i) ? "application/json" : "application/x-www-form-urlencoded"), Object.keys(t).forEach(function (i) {
